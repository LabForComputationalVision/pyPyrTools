...
class maxPyrHtTests(unittest.TestCase):
    def test1(self):
        self.assertTrue(ppt.maxPyrHt((1,10),(3,4)) == 0)
    def test2(self):
        self.assertTrue(ppt.maxPyrHt((10,1),(3,4)) == 0)
    def test3(self):
        self.assertTrue(ppt.maxPyrHt((10,10),(1,4)) == 4)
    def test4(self):
        self.assertTrue(ppt.maxPyrHt((10,10),(3,1)) == 2)
    def test5(self):
        self.assertTrue(ppt.maxPyrHt((10,10),(3,4)) == 2)
    def test6(self):
        self.assertTrue(ppt.maxPyrHt((20,10),(5,1)) == 2)
    def test7(self):
        self.assertTrue(ppt.maxPyrHt((10,20),(5,1)) == 2)
    def test8(self):
        self.assertTrue(ppt.maxPyrHt((20,10),(1,5)) == 5)
    def test9(self):
        self.assertTrue(ppt.maxPyrHt((10,20),(1,5)) == 5)
    def test10(self):
        self.assertTrue(ppt.maxPyrHt((256,1),(1,5)) == 6)
    def test11(self):
        self.assertTrue(ppt.maxPyrHt((256,1),(5,1)) == 6)
    def test12(self):
        self.assertTrue(ppt.maxPyrHt((1,256),(1,5)) == 6)
    def test13(self):
        self.assertTrue(ppt.maxPyrHt((1,256),(5,1)) == 6)
